...
const I18N = {
  en: {
    ...
    addAllToMyList: 'Add all to my videos',
    addingAllToast: 'Adding videos…',
    allAddedToast: n => `${n} video${n===1?'':'s'} added to your videos`,
  ...
  ar: {
    ...
    addAllToMyList: 'أضف الكل إلى فيديوهاتي',
    addingAllToast: 'جارٍ إضافة الفيديوهات…',
    allAddedToast: n => `تمت إضافة ${n} فيديو إلى فيديوهاتك`,
